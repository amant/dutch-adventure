  ...
  <div class="er-drill">
    <div class="card drill-card">
      <div class="header">
        ...
        <div class="badge">Mastering 'Er' & Position</div>
      </div>
      ...
      <div v-if="exercise.erDrillData" class="sentence-display mt-6">
        <p class="sentence">{{ exercise.erDrillData.sentence }}</p>
      </div>

      <div v-if="exercise.erDrillData" class="options-grid mt-6">
        <button
        ...
        >
          <div class="option-content">
            ...
            <span v-if="option.function" class="function-tag">{{ option.function }}</span>
          </div>
        </button>
      </div>
    ...
    <div v-if="feedback" class="feedback-section mt-6">
      <div class="card feedback-card" :class="feedback.outcome">
        ...
        <div v-if="exercise.erDrillData?.explanation || feedback.explanation" class="explanation-box mt-4">
