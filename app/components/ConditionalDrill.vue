  ...
  <div class="conditional-drill">
    <div class="card drill-card">
      ...
      <div class="instruction">
        ...
        <p class="muted">
          Fuse the main action and condition into a precise Dutch sentence using the specified conditional or restrictive construction.
          Ensure accurate subclause verb-final word order, correct conjunction selection, and proper clause inversion where required.
        </p>
      </div>
      ...
      <div class="drill-sources-view mt-6">
        <div class="premises-grid">
          ...
          <div class="condition-divider">
            <span class="condition-badge">⚡ VOORWAARDE / UITZONDERING</span>
          </div>
...
<style scoped>
.conditional-drill { max-width: 650px; margin: 0 auto; }
...
.source-box.main-box { background: #f8fafc; }
.source-box.condition-box { background: #f8fafc; }
...
.pill.formula code { font-family: monospace; font-size: 12px; color: #0d9488; font-weight: 600; }
...
.lesson-header { display: flex; align-items: center; gap: 8px; margin-bottom: 8px; color: #115e59; }
