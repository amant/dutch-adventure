...
<template>
  <div class="participial-drill">
    <div class="card drill-card">
      <div class="header">
        <div class="eyebrow">
          B2 Advanced Syntax & Participial Mastery
        </div>
        <div class="badge">
          {{ typeBadge }}
        </div>
      ...
      <div class="drill-sources-view mt-6">
        <div class="source-box base-clause-box">
          <div class="box-label">
            Uitgangszin / Beschrijving (Base Clause / Description)
          </div>
          <p class="source-text">
            {{ exercise.participialData?.baseClause }}
          </p>
        </div>

        <div
          v-if="exercise.participialData?.structureFormula || exercise.participialData?.participleCue"
        ...
        >
          ...
          <div class="blueprint-pills">
            <span
              v-if="exercise.participialData?.participleCue"
              class="pill cue"
            >
              Kerndeelwoord / Cue: <strong>{{ exercise.participialData.participleCue }}</strong>
            </span>
            <span
              v-if="exercise.participialData?.structureFormula"
              class="pill formula"
            >
        ...
        <div class="source-box combined-target">
          <div class="box-label">
            Jouw Deelwoordconstructie (Your Participial Phrase / Sentence)
          </div>
          <div class="input-wrapper">
            ...
            />
            <div
              v-if="exercise.participialData?.hint"
              class="hint-text"
            >
