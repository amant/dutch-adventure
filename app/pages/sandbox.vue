  ...
  <div class="sandbox-page">
    <div class="hero">
      <div class="eyebrow gold">
        CUSTOM VOYAGE GENERATOR
      </div>
      <h1>Scenario Sandbox</h1>
      <p class="muted">
        Tell the AI where you are and what mission you're trying to achieve. We'll weave in the Dutch concepts from your learning log to make real-world practice relevant to <i>your</i> life.
      </p>
    </div>
    ...
    <div class="sandbox-grid">
      <div class="card design-card">
        ...
        <p class="small muted">
          Enter a specific real-world scenario or goal. For example: "I am at a tech conference in Amsterdam and I want to explain my app."
        </p>
      ...
      <div class="card frontier-card">
        ...
        <p class="small muted">
          These concepts from your "Learning Frontier" will be actively prioritized during this mission:
        </p>
        ...
        >
          Keep practicing to identify your frontier concepts!
        </p>

        <div class="info-box">
          <p class="small">
            <b>Why these?</b> These are concepts you recognize but haven't used spontaneously yet. The sandbox forces you to activate them.
          </p>
        </div>
      </div>
    </div>
