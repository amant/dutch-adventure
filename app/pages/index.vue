...
<template>
  <section class="home">
    ...
    <div class="hero-banner">
      <div class="hero-left">
        <div class="eyebrow gold">GRAND LINE OF DUTCH FLUENCY</div>
        <h1 class="hero-title">
        ...
        <div class="hero-actions">
          <NuxtLink to="/chapter/opinions-en-redenen" class="button large gold">
            <span>⚔️ Set Sail Now</span>
          </NuxtLink>
          <NuxtLink to="/progress" class="button large secondary">
    ...
    <div v-if="bottlenecks.length > 0" class="section-container bottlenecks-section">
        ...
        >
          <div class="b-meta">
            ...
            <div class="b-info">
              ...
              <span class="status-chip" :class="b.status">{{ b.status === 'red' ? 'Urgent' : 'Needs Focus' }}</span>
            </div>
          </div>
          <p class="b-text">{{ b.text }}</p>
          <NuxtLink :to="b.action" class="button small" :class="b.status === 'red' ? 'battle-red' : 'secondary'">
            {{ b.actionLabel }}
          </NuxtLink>
        </div>
      </div>
    ...
    <div v-if="frontier.length > 0" class="section-container frontier-section">
    ...
    <div class="card sandbox-cta ocean-gradient">
      <div class="cta-content">
        <div class="eyebrow gold">OPEN SEA EXPEDITION</div>
        ...
        <NuxtLink to="/sandbox" class="button gold large">
