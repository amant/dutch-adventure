...
<template>
  ...
  <section v-else-if="session?.stage?.value && session?.exercise?.value" class="session">
    ...
    <article class="card exercise">
      ...
      <div v-else-if="session.exercise.value.kind === 'participial-drill'" class="renderer">
        <ParticipialDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
      ...
      <div v-else-if="session.exercise.value.kind === 'correlative-drill'" class="renderer">
        <CorrelativeDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
      ...
      <div v-else-if="session.exercise.value.kind === 'conditional-drill'" class="renderer">
        <ConditionalDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
      ...
      <div v-else-if="session.exercise.value.kind === 'causality-drill'" class="renderer">
        <CausalityDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
      ...
      <div v-else-if="session.exercise.value.kind === 'prefix-verb-drill'" class="renderer">
        <PrefixVerbDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
      ...
      <div v-else-if="session.exercise.value.kind === 'midfield-drill'" class="renderer">
        <MidfieldDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
      ...
      <div v-else-if="session.exercise.value.kind === 'fixed-preposition-drill'" class="renderer">
      ...
      <div v-else-if="session.exercise.value.kind === 'pronominal-splitting-drill'" class="renderer">
      ...
      <div v-else-if="session.exercise.value.kind === 'aspect-drill'" class="renderer">
        <AspectDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
      ...
      <div v-else-if="session.exercise.value.kind === 'modal-particle-drill'" class="renderer">
        <ModalParticleDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
      ...
      <div v-else-if="session.exercise.value.kind === 'topicalisation-drill'" class="renderer">
        <TopicalisationDrill
          :exercise="session.exercise.value"
          :feedback="feedback"
          @submit="submit"
