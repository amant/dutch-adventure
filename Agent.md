...
- **Capabilities**: Group chapters by CEFR level (A1 Survival, A2 Everyday Independence, B1 Independent Communication, B2 Complex Communication).
  ...
  - **A2 Functional Independence**: Doctor appointments, describing daily routines & past actions, bakery orders, public transit & train travel, house hunting & rental viewings, and simple past narrative storytelling (OVT).
