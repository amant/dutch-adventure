...
- **Naturalness & Pragmatic Competence**: Moving beyond "correctness" to "naturalness".
    ...
    - **Fixed Prepositions & Prepositional Regimes (Voorzetselvoorwerpen & Werkwoordelijke Regimes)**: Training for B2 learners to master fixed prepositions governed by verbs, adjectives, and nouns (*vaste voorzetsels*), eliminating cross-linguistic preposition transfer errors (e.g., *twijfelen aan*, *rekening houden met*, *bestand zijn tegen*, *zich neerleggen bij*, *bijdragen aan*, *voldoen aan*, *inspelen op*, *gepaard gaan met*, *voorzien in*, *opgewassen tegen*, *behoefte aan*, *bezwaar tegen*), mastering preposition selection across abstract domains, and correctly constructing prepositional objects.
    - **Pronominal Adverb Splitting & Word Order (Splitsing van het Voornaamwoordelijk Bijwoord)**: Training for B2 learners to master the natural splitting of pronominal adverbs (*er... over*, *waar... naar*, *daar... aan*, *hier... mee*, *nergens... in*, *overal... naar*, *ergens... over*) across main clauses, subclauses, questions, and topicalized sentences, separating the R-word from the preposition and positioning the stranded preposition immediately before the final verbal group or predicate.
    - **Aspectual Verbs, Posture Verbs & Progressive Aspect (Aspectuele Werkwoorden & Duurconstructies)**: Training for B2 learners to master Dutch aspectual and durative systems: physical posture verbs (*zitten / staan / liggen / lopen / hangen te + infinitief*), dynamic progressive (*aan het + infinitief zijn*), imminent action (*op het punt staan om te*), customary/habitual formal aspect (*plegen te*), prospective danger or promise (*dreigen te / beloven te*), and the Infinitivus Pro Participio (IPP) double infinitive rule in perfect tenses (*heeft zitten kijken*).
    - **Modal Particle Combinations & Pragmatic Shading (Modale Partikels & Schakeringspartikels in de Praktijk)**: Training for B2 learners to master the pragmatic engine of spoken and written Dutch: modal particle stacking and shading (*wel, toch, maar, eens, even, nou, immers*, clusters like *toch maar eens, nou eenmaal, wel degelijk, dan maar, eens even, maar beter*), positioning particles in the inner midfield to soften commands, assert undeniable facts against skepticism, concede inevitable realities, or urge action tactfully.
    - **Focus Fronting, Topicalisation & Emphatic Inversion (Topicalisatie & Emfatische Woordvolgorde)**: Training for B2 learners to master Dutch information packaging: fronting direct/indirect objects with V2 inversion (*Dát rapport hebben we ingediend*), infinitive topicalisation triggering supportive auxiliary *doen* (*Twijfelen doe ik niet*), participle fronting for contrast (*Gelezen heeft hij het wel*), left-dislocation with resumptive pronouns (*Die regel, die moeten we handhaven*), cleft focus sentences (*Het is juist door die innovatie dat...*), and inverted conditional focus (*Mocht er vertraging optreden...*).
...
- **Capabilities**: Group chapters by CEFR level (A1 Survival, A2 Everyday Independence, B1 Independent Communication, B2 Complex Communication).
  - **A1 Survival & Everyday Basics**: Self-introductions, asking directions and navigating town, supermarket & grocery transactions, telling time & appointment scheduling, ordering food & drinks, and the A1 Amsterdam Survival Capstone.
  - **A2 Functional Independence**: Doctor appointments, describing daily routines & past actions, bakery orders, public transit & train travel, house hunting & rental viewings, simple past narrative storytelling (OVT), and the A2 Moving Day Capstone (verhuisdag).
  - **B1 Independent Communication & Workplace Navigation**: Expressing opinions & reasons, hotel & landlord negotiation missions, expressing doubt & certainty, connecting ideas with pronominal adverbs, professional workplace email drafting, debating with nuanced agreement/disagreement, and navigating municipal bureaucracy (BSN/Gemeente).
  - **B2 Complex Communication & Syntactic Architecture**: Full B2 matrix spanning midfield word order (TMP), fixed prepositions, R-word splitting, aspectual & posture verbs, modal particle shading, focus fronting & topicalisation, 17th-century maritime history, privateers vs pirates (kaapvaart & zeeroof), living nautical idioms, Dutch football culture, Total Football (Totaalvoetbal), the invention of Tiki-Taka at FC Barcelona (passing triangles, positional rondos, the third man), Johan Cruijff's philosophy and linguistic aphorisms (Cruijffiaans, including "Elk nadeel heb z'n voordeel"), passives, reported speech, and advanced professional debate.
...
- **Components**:
    ...
    - `FixedPrepositionDrill.vue`: Interactive tool for mastering Dutch fixed prepositions, prepositional regimes, and eliminating cross-linguistic preposition transfer errors across verbs, adjectives, and nouns.
    - `PronominalSplittingDrill.vue`: Interactive tool for mastering Dutch pronominal adverb splitting, R-word early placement, and stranded preposition positioning before the verbal cluster.
    - `AspectDrill.vue`: Interactive tool for mastering Dutch aspectual and durative constructions, posture verbs (zitten/staan/liggen/lopen te), dynamic progressive (aan het zijn), imminent action (op het punt staan om te), customary plegen te, and double infinitive IPP in perfect tenses.
    - `ModalParticleDrill.vue`: Interactive tool for mastering Dutch modal particle combinations and pragmatic shading (wel degelijk, nou eenmaal, toch maar eens, dan maar, eens even, maar beter) in the inner midfield.
    - `TopicalisationDrill.vue`: Interactive tool for mastering Dutch focus fronting, infinitive topicalisation with auxiliary doen, participle fronting, left-dislocation with resumptive pronouns, and cleft sentences.
